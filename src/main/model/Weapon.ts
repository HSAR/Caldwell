...
console.log(JSON.stringify(
    [
        new WeaponSerialization("weapon_autocannon_30mm_Mk44", "Mk44 Bushmaster II 30mm autocannon", 160, 0, 750, ["slot_weapon_cannon"], ["slot_loader_cannon"], "ammo_030x173mm", 3.33, 8.6, 200000, 50),
