...
export class AmmoType {
    ...
    static fromJSON(serialized:AmmoType): AmmoType {
        let user = Object.create(AmmoType.prototype);
        return new AmmoType(
            serialized.id,
            serialized.name,
            serialized.mass,
...
console.log(JSON.stringify(
    [
        ...
        new AmmoType("ammo_012x099mm", "12.7mm M2 Armour-Piercing (AP)", 0.115, "ammo_012x099mm", 1, 900, 2),
        new AmmoType("ammo_012x099mm", "12.7mm Mk323 Polymer-Cased Ball", 0.086, "ammo_012x099mm", 1, 900, 2)
    ]
));